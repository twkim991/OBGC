        ...
        <aside class="action-panel" aria-labelledby="lost-action-title">
          ...
          <template v-else>
            ...
            <div v-if="canPlayCard" class="play-actions">
              <button type="button" class="primary" :disabled="!canPlaySelected || actionPending" @click="playSelected('expedition')">탐험대에 놓기</button>
              <button type="button" class="secondary" :disabled="!selectedCard || actionPending" @click="playSelected('discard')">버리기</button>
            ...
            <div v-if="canDrawCard" class="draw-actions">
              <button type="button" class="deck-button" :disabled="actionPending || !state?.deckCount" @click="drawDeck">
